...
module.exports = async (req, res) => {
    ...
    try {
        ...
        if (action === 'login') {
            ...
            const userResult = await client.query('SELECT * FROM auth.verify_user($1::TEXT, $2::TEXT)', [email, password]);
        ...
        if (action === 'verify') {
            ...
            // Verify session
            const sessionResult = await client.query('SELECT * FROM auth.verify_session($1::TEXT)', [sessionToken]);
        ...
        if (action === 'changePassword') {
            ...
            const verifyResult = await client.query('SELECT * FROM auth.verify_user($1::TEXT, $2::TEXT)', [user.res_email, currentPassword]);
